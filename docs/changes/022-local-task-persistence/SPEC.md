...
- Android instrumentation sources compiled successfully. The focused Task
  ...
  skips, failures, or errors. A broader all-app connected run had one
  pre-existing UI timeout outside this change's scope.
- Schema 6 was generated by Room/KSP and inspected. Schemas 1–5 are unchanged;
  schema 6 adds only `tasks`.

## Authority and stop conditions

Do not commit, push, merge, release, or mark review pass. Stop and report
